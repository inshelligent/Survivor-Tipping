...
def create_db():
    ...
    hayley = models.Contestant(id=1, name='Hayley', age=31, occupation='Pain Researcher', description='test', is_eliminated=False)
    ...
    george = models.Contestant(id=2, name='George', age=31, occupation='Public Servant', description='test', is_eliminated=False)
